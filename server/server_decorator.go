...
// It prompts the user to select a type of server to launch and initializes the corresponding server.
// The selected server is then registered with the root handler and the program starts listening for incoming requests.
func main() {
